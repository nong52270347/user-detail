<%@ page import="user.detail.Role; user.detail.User" %>
<!doctype html>
<html>
	<head>
			...
			<g:form action="save" >
				<fieldset class="form">
                    ...
                    <div class="fieldcontain ${hasErrors(bean: userInstance, field: 'cityId', 'error')} required">
                        ...
                        <g:textField name="cityId" value="${userInstance?.cityId}" required="" />
                    </div>
                    ...
                    <div class="fieldcontain ${hasErrors(bean: userInstance, field: 'milId', 'error')} required">
                        ...
                        <g:textField name="milId" value="${userInstance?.milId}" required="" />
                    </div>
                    ...
                    <div class="fieldcontain ${hasErrors(bean: userInstance, field: 'authorities', 'error')} required">
                        ...
                        <g:select name="role" from="${Role.all}" optionKey="id" optionValue="label" required="" value="${params.role ?: Role.findByAuthority('ROLE_USER').id}" />
                    </div>
