            ...
            <g:if test="${userInstance?.milId}">
				...
				<li class="fieldcontain">
					<span id="gender-label" class="property-label"><g:message code="user.gender.label" default="Gender" /></span>
						...
						<span class="property-value" aria-labelledby="gender-label"><g:message code="user.gender.${userInstance.gender}" /></span>
				...
				<g:if test="${userInstance?.creator}">
				<li class="fieldcontain">
					<span id="creator-label" class="property-label"><g:message code="user.creator.label" default="Creator" /></span>
					
						<span class="property-value" aria-labelledby="creator-label"><g:link controller="user" action="show" id="${userInstance?.creator?.id}">${userInstance?.creator?.username?.encodeAsHTML()}</g:link></span>
				...
				<li class="fieldcontain">
					<span id="updator-label" class="property-label"><g:message code="user.updator.label" default="Updator" /></span>
						...
						<span class="property-value" aria-labelledby="updator-label"><g:link controller="user" action="show" id="${userInstance?.updator?.id}">${userInstance?.updator?.username?.encodeAsHTML()}</g:link></span>
